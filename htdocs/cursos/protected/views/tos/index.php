...
<h2><?php echo Yii::t( 'global', 'tos' ) ?></h2>

<pre>
Codebit training, Términos y condiciones
...
El contenido de programas publicados por Codebit son de uso educativo, cualquier uso con fines ilicitos de los mismos son responsabilidad de quien los utiliza y mas no de Codebit.


4. Confidencialidad
Codebit tendrá la confidencialidad de seguridad de la información facilitada por el Cliente para el cobreo de servicios, tal como lo describe la Ley de Protección de Datos.

5. Cancelación de inscripción
De acuerdo a la fecha de solicitud se aplicará el porcentaje señalado en la tabla para el cálculo de la cancelación de saldos del participante:

-  4 días antes del inicio del  curso 100%
-  2 días antes del inicio del  curso  50%
- 12 horas antes del inicio del curso   0%

Codebit, y todos sus programas derivados, son Marca registrada y queda prohibido su uso sin alguna autorización.
</pre>